...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-312-erd-s-problem-312-2ccb0dfd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-312"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-312-erd-s-problem-312-2ccb0dfd-v1",
      "problem_contract_sha256": "9386cb34f4c1adb883cbee2f8eeff4c8efa039045467a54378cc4edcaa770b00",
      "problem_id": "problem:um-ep-312-erd-s-problem-312-2ccb0dfd",
      "route_id": "route:um-ep-312-erd-s-problem-312-2ccb0dfd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-312-erd-s-problem-312-2ccb0dfd-source-fidelity-01",
      "graph_id": "graph:um-ep-312-erd-s-problem-312-2ccb0dfd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-312-erd-s-problem-312-2ccb0dfd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-312-erd-s-problem-312-2ccb0dfd-root",
          "statement": {
          ...
          "statement_sha256": "b564629c7b28bf083c22f4f0e38b4e6dd02cf60d06f42b86e4eb219380efd65f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-312-erd-s-problem-312-2ccb0dfd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-312-erd-s-problem-312-2ccb0dfd-root",
      "route_id": "route:um-ep-312-erd-s-problem-312-2ccb0dfd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-312-1e0656f69e84",
        "url": "https://www.unsolvedmath.com/problems/EP-312"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
